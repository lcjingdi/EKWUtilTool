...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/lcjingdi/EKWUtilTool"
  ...
  s.source       = { :git => "https://github.com/lcjingdi/EKWUtilTool.git", :tag => s.version.to_s }
  ...
  s.source_files  = "EKWUtilTool/EKWUtilTool/**/*.{h,m}"
